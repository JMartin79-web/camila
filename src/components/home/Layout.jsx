        ...
        <div className={`contains-header ${openNav ? 'header-open' : ''}`} id="header">
            ...
            <div className="header1">
                <header className={`header`}>
                    ...
                    <div className="header-links">
                        {navList.map(link => <a href='#' key={link}><button onClick={() => scrollToSection(link)}>{link}</button></a>)}
                    </div>
            ...
            <div id="header2" className={`header2 leading-tight pb-4 ${openNav ? 'header2-active' : ''}`}>
                <div className="header2-links">
                    {navList.map(link => <a key={link + 'mobile'} href='#'><button onClick={() => scrollToSection(link)}>{link}</button></a>)}
                </div>
            </div>
        </div>
